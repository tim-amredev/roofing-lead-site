document.addEventListener('DOMContentLoaded', function() {
  ...
  const pricing = {
    materials: {
      asphalt: { low: 4.50, high: 7.50, name: "Asphalt Shingles" },
      premium: { low: 6.50, high: 11.00, name: "Premium Shingles" },
      metal: { low: 9.00, high: 17.00, name: "Metal Roofing" },
      wood: { low: 8.00, high: 15.00, name: "Wood Shingles" },
      tile: { low: 13.00, high: 27.00, name: "Clay/Concrete Tile" },
      slate: { low: 20.00, high: 45.00, name: "Slate" }
    },
    roofSizes: {
